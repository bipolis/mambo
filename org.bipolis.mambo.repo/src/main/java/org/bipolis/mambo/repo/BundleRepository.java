 ...
 *
 */
//@Designate(ocd = org.bipolis.mambo.repo.BundleRepository.Config.class)
@Component(immediate = true, service = BundleRepository.class)//, configurationPolicy = REQUIRE)
public class BundleRepository {

  public RepositoryAdditionResult addBundle(InputStream inputStream,
                                            String path) {
    // TODO Auto-generated method stub
    return null;
  }

  public Path bundleFile(String path) {
    // TODO Auto-generated method stub
    return null;
  }

  public Path indexFile(String path) {
    // TODO Auto-generated method stub
    return null;
  }

  public boolean deleteBundle(String path) {
    // TODO Auto-generated method stub
    return false;
  }
...
//    String repoDir() default "data/repo";
//
//
//    @AttributeDefinition(
//            name = "Repository URL",
//            description = "URL for remotely accessing the repository")
//    String repoUrl() default "https://localhost:8080/repo/obr";
//  }
//
...
//
//    final String root = config.repoDir();
//    final String repoUrl = config.repoUrl();
//
...
//                                  .isEmpty()) {
//      throw new IllegalStateException("config: Repository URL (repoUrl) is not configured.");
//    }
//
...
//    indexerConfig.put(ResourceIndexer.URL_TEMPLATE, repoUrl + "/%p%f");
//
//    try {
