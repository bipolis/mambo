...
@Component(property = {
		JaxRSWhiteboardConstants.JAX_RS_APPLICATION_SELECT + "=(osgi.jaxrs.name=" + ApplicationExample.APPLICATION_NAME
				+ ")",
		JaxRSWhiteboardConstants.JAX_RS_NAME + "=ExampleRessource",
		JaxRSWhiteboardConstants.JAX_RS_RESOURCE + "=true" }, service = { ExampleRessource.class })
